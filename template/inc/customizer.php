...
function template_customize_preview_js() {
	wp_enqueue_script( 'template-customizer', get_template_directory_uri() . '/common/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
